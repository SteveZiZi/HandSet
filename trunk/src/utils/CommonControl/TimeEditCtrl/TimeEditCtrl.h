#ifndef TIME_EDIT_CTRL_H_

#define TIME_EDIT_CTRL_H_
...
///
#define WM_TIME_EDIT_CANCLE PUBLIC_WND_USERID+100
#define WM_TIME_EDIT_APPLY  PUBLIC_WND_USERID+101

// 默认开启双缓冲机制
#ifndef TIME_EDIT_DOUBLEBUFFER
#define TIME_EDIT_DOUBLEBUFFER
#endif

class CTimeEditCtrl:public CEdit
{
public:
	//
	//=============================================================================
	...
	void  Str2SysTime(const CString &str, SYSTEMTIME &time);
	void  SysTime2Str(const SYSTEMTIME &time, CString &str);
protected:
	//
	//=============================================================================
	// 消息处理
