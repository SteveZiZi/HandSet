...
///    |               |           |                                                          |
///
#ifndef NANRUI_FT3_TYPES_H_

#define NANRUI_FT3_TYPES_H_

#include "src\include\stdint.h"

///
/// @brief
///     南瑞FT3采样值报文（含CRC）每帧报文长度为28words
///
#define NANRUI_FT3_MSG_WORD       28

///
/// @brief
///     南瑞FT3采样值报文的应用服务数据单元（ASDU）中除采样值信息外的公共信息
///
typedef struct
{
...
}NANRUI_FT3_ASDU_PUBLIC;

///
/// @brief
///     南瑞FT3采样值报文的应用服务数据单元（ASDU）中除采样值信息外的公共信息的偏移地址信息
///
typedef struct
{
