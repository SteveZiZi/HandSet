#ifndef TRIPHASE_CT_FT3_ASDU_SEG_H_

#define TRIPHASE_CT_FT3_ASDU_SEG_H_
...
///
/// @brief
///     三相电流互感器FT3采样值报文的ASDU的数据通道数
///
#define TRIPHASE_CT_FT3_ASDU_CHANNEL_NUM  9

class TriphaseCTFT3AsduSeg:public CTorVTFT3AsduSeg
{
public:
	TriphaseCTFT3AsduSeg();
	virtual ~TriphaseCTFT3AsduSeg();
