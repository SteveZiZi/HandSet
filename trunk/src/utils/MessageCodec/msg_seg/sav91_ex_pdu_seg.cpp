...
///
/// @brief
///     Sav91Ex（IEC91850-9-1扩展）采样值报文的PDU段
///
/// @note
///
...
///
/// @brief
///     Sav91Ex PDU段落中去除ASDU后的剩余部分的最大Size
///
...
///
/// @brief
///     设置Sav91ExPDU所属的上层协议类型，以重置Sav91ExPdu的最大Size
///
/// @param[in]
///     type - Sav91ExPDU所属的上层协议类型
///
/// @return
///     
///
