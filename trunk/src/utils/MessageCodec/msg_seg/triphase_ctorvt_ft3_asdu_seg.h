#ifndef TRIPHASE_CTORVT_FT3_ASDU_SEG_H_

#define TRIPHASE_CTORVT_FT3_ASDU_SEG_H_
...
///
/// @brief
///     三相电流/电压互感器FT3采样值报文的ASDU的数据通道数
///
#define TRIPHASE_CTORVT_FT3_ASDU_CHANNEL_NUM  15

class TriphaseCTorVTFT3AsduSeg:public CTorVTFT3AsduSeg
{
public:
	TriphaseCTorVTFT3AsduSeg();
	virtual ~TriphaseCTorVTFT3AsduSeg();
