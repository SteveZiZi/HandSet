#ifndef TRIPHASE_VT_FT3_2010_ASDU_SEG_H_

#define TRIPHASE_VT_FT3_2010_ASDU_SEG_H_
...
///
/// @brief
///     三相电压互感器FT3采样值报文（2010）的ASDU的数据通道数
///
#define TRIPHASE_VT_FT3_2010_ASDU_CHANNEL_NUM  6

class TriphaseVTFT3_2010AsduSeg:public CTorVTFT3AsduSeg
{
public:
	TriphaseVTFT3_2010AsduSeg();
	virtual ~TriphaseVTFT3_2010AsduSeg();
