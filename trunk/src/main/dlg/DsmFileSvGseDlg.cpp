...
#define DSM_FILE_BROWSER_NAME           247                         ///< 名字区域长度
#define DSM_FILE_BROWSER_SIZE           81                          ///< 文件大小
#define DSM_FILE_BROWSER_TYPE           57                         ///< 文件类型
#define DSM_FILE_BROWSER_TIME           144                        ///< 文件修改日期
