...
#include "BasicParamAddGooseRxFromSclDlg.h"
...
IMPLEMENT_DYNAMIC(CBasicParamAddGooseRxFromSclDlg, CBaseDlg)

CBasicParamAddGooseRxFromSclDlg::CBasicParamAddGooseRxFromSclDlg(CWnd* pParent /*=NULL*/)
: CBaseDlg(CBasicParamAddGooseRxFromSclDlg::IDD, DSM_STR_BASIC_PARAM_ADD_GOOSE_FROM_SCL_CAPTION, pParent)
{
...
CBasicParamAddGooseRxFromSclDlg::~CBasicParamAddGooseRxFromSclDlg()
{
}

void CBasicParamAddGooseRxFromSclDlg::DoDataExchange(CDataExchange* pDX)
{
	CBaseDlg::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CBasicParamAddGooseRxFromSclDlg, CBaseDlg)
	ON_NOTIFY(ELNM_ITEM_CHECKED, IDC_BASIC_PARAM_CTRL_BLOCK_FROM_SCL_RET, &CBasicParamAddGooseRxFromSclDlg::OnGooseSelItemValueChanged)
END_MESSAGE_MAP()


// CAddGooseFromSclDlg 消息处理程序

BOOL CBasicParamAddGooseRxFromSclDlg::OnInitDialog()
{
...
void CBasicParamAddGooseRxFromSclDlg::_creatCtrlBlockReport()
{
	CRect rcReport;
...
void CBasicParamAddGooseRxFromSclDlg::OnGooseSelItemValueChanged(NMHDR* pNotifyStruct, LRESULT* pResult)
{
...
void CBasicParamAddGooseRxFromSclDlg::_SavePage()
{
