...
MEMORY {
   ...
   DDR2        : origin = 0x87a00080,  len = 0x1fff80
   L1DSRAM     : origin = 0x10f04000,  len = 0x4000
   IRAM        : origin = 0x107f8000,  len = 0x10000
   RESET_VECTOR : origin = 0x87a00000, len = 0x80
   DSPLINKMEM  : origin = 0x87c00000,  len = 0x230000
   POOLMEM     : origin = 0x87e30000,  len = 0x1d0000
}
/* MODULE CLK */
SECTIONS {
   .clk: {
