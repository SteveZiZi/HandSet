...
#define IOCTRL_SET_FT3_TX_STYLE  /*  设置FT3发送端口发送报文的类型    */\
...
#define IOCTRL_SET_ADJUST_VAL    /*  设置时钟偏差值                   */\
    CTL_CODE(FILE_DEVICE_UNKNOWN, 0x030F, METHOD_BUFFERED, FILE_ANY_ACCESS)


//-----TEST
#define IOCTRL_SET_GPMC  \
    CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0316, METHOD_BUFFERED, FILE_ANY_ACCESS)


#define IOCTRL_SAVE_REGISTER     /*  光机前通知驱动保存必要的值      */\
    CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0340, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define WM_CHANGE_TX          WM_USER + 101
#define WM_RECOVER_TX          WM_USER + 102
#define WM_STOP_TX          WM_USER + 103
#define WM_SEND_BCODE       WM_USER + 104
//-------------------------  FT3  ----------------------------------
/*
 *  FT3 发送IOCTRL配置参数
 */
...
typedef enum {
    _TX_FT3 = 0,                        //FT3 TX端口 发送FT3报文
    _TX_IRIGB                           //FT3 Tx端口 发送IRIG_B码
}FT3_IRIGB_TX_STYLE_e;
